...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Header
      as='h2'
      content="See where your money's going "
      inverted
      style={{
      ...
      <Grid container stackable verticalAlign='middle'>
        ...
        <Grid.Row>
          <Grid.Column textAlign='center'>
            <Button size='huge'>Button Not working</Button>
          </Grid.Column>
        </Grid.Row>
      </Grid>
    </Segment>
          ...
          <Grid.Row>
            <Grid.Column width={7}>
              <Header as='h4' inverted>
                <em>Copyright of</em> <u> Evan Kim</u>
              </Header>
              <p>
                This is Evan's 3rd project called <b>Find Balance.</b>
              </p>
            </Grid.Column>
          </Grid.Row>
        </Grid>
